...
{{% notice style="warning" title="Lifetime Starts at Provisioning" %}}
The instance **Lifetime** starts ticking from this date/time, so adjust the lifetime accordingly.
{{% /notice %}}

{{% notice style="tip" title="Provisioning Time Tip" %}}
...
{{% notice style="tip" title="Event Start Time Tip" %}}
...
{{% notice style="tip" title="Large Workshop Tip" %}}
...
{{% notice style="warning" title="Ensure Attendees Enrol" %}}
...
{{% notice style="info" title="Alternative: Use a Normal Workshop" %}}
