...
<figure style="width: 80%; margin: 0 0 1rem 0;">
  ...
  <figcaption style="text-align: center; font-size: 0.9em; color: var(--MENU-SECTIONS-LINK-color); margin-top: 0.5rem; font-style: italic;">
    Add an activity to use an always-on demo on the Use Instance button or simply click on the name of the demo itself
  </figcaption>
</figure>

The connection infomation for always-on demos is blurred out by default. You will need to add at least one activity before the connection details become available to you. To add an activity, click on either **Add activity** at the top of the page or the **+ New activity** button at the bottom of the page. Once you have added an activity the connection information will be displayed.

{{% notice style="info" title="Adding an Activity" %}}
See [Creating Demos](/demos/creating-demos/#use-case) for information and guidance on adding an activity.
{{% /notice %}}
