...
<img src="/images/email_notifications.png" alt="my_page" style="width: 50%; height: auto; display: block; margin: 0;">
...
<img src="/images/add_notification.png" alt="my_page" style="width: 60%; height: auto; display: block; margin: 0;">

<figure style="max-width: 50%; margin: 0 0 1rem 0;">
  <img src="/images/email_notification.png" alt="my_page" style="width: 100%; height: auto; display: block; margin: 0;">
...
<img src="/images/unlink_slack.png" alt="my_page" style="width: 30%; height: auto; display: block; margin: 0;">

<img src="/images/disable_email_notifications.png" alt="my_page" style="width: 30%; height: auto; display: block; margin: 0;">
...
<img src="/images/slackbot.png" alt="my_page" style="width: 20%; height: auto; display: block; margin: 0;">
...
* `/list-workshops` - provides the same functionality as above, but for workshops.
  ...
  <figure style="max-width: 60%; margin: 0 0 1rem 0;">
    <img src="/images/slackbot_example.png" alt="my_page" style="width: 100%; height: auto; display: block; margin: 0;">
    <figcaption style="text-align: center; font-size: 0.9em; color: var(--MENU-SECTIONS-LINK-color); margin-top: 0.5rem; font-style: italic;">
...
<figure style="max-width: 40%; margin: 0 0 1rem 0;">
  <img src="/images/in_app_notifications.png" alt="my_page" style="width: 100%; height: auto; display: block; margin: 0;">
  <figcaption style="text-align: center; font-size: 0.9em; color: var(--MENU-SECTIONS-LINK-color); margin-top: 0.5rem; font-style: italic;">
